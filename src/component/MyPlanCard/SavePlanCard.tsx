    ...
    <div className="flex w-full items-center gap-4 rounded-2xl border border-[#252a33] bg-[#15181e] p-3">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <Link href={`/AllWork/${work.id}`}>
          <button
            type="button"
            className="hidden h-9 cursor-pointer items-center rounded-full border border-[#343b47] px-4 text-[11px] font-medium text-[#d4d6dc] transition hover:border-[#626b7a] hover:text-white sm:flex"
          >
            View Details
          </button>
        </Link>
