    ...
    <div className="grid grid-cols-1 md:grid-cols-2 w-full  items-center gap-4 rounded-2xl border border-[#252a33] bg-[#15181e] p-3">
      ...
      <div className="flex shrink-0 items-center justify-start md:justify-end gap-2">
        ...
        <Link href={`/AllWork/${work.id}`}>
          <button
            type="button"
            className=" h-9 cursor-pointer items-center font-inter rounded-full border border-[#343b47] px-4 text-[11px] font-medium text-[#d4d6dc] transition hover:border-[#626b7a] hover:text-white sm:flex"
          >
            View Details
          </button>
        </Link>
